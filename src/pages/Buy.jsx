                        ...
                        <Link to={`/property/${p.id}`} key={p.id}>
                            ...
                            >
                                <div className="relative overflow-hidden mb-6 aspect-[4/3]">
                                    ...
                                    <div className="absolute top-4 left-4 bg-white/95 backdrop-blur-sm text-primary text-[10px] font-bold px-3 py-2 uppercase tracking-widest border-l-2 border-secondary">
                                        Exclusivité
                                    </div>
                                </div>
                                <div>
